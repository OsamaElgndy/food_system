...
<section  className='container' style={{padding:"10px 80px" ,marginTop:"20px", background:"#F0FFEF"}}>
           ...
           <div>
               ...
               }}  className='  p-2  rounded-3 d-flex justify-content-evenly  align-items-center ' style={{width:"200px" , background:"#009247" , color:"white"}}> fill recipes <span><i class="fa-solid fa-arrow-right"></i></span> </button>
           </div>
           </div>
            </section>
